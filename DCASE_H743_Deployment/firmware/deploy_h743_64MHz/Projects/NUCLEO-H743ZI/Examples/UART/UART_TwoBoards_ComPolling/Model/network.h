...
#define AI_NETWORK_IN_1_HEIGHT      (256)
#define AI_NETWORK_IN_1_WIDTH       (65)
#define AI_NETWORK_IN_1_CHANNEL     (1)
#define AI_NETWORK_IN_1_SIZE        (16640)
#define AI_NETWORK_IN_1_SIZE_BYTES  (16640)
...
#define AI_NETWORK_OUT_1_SIZE_BYTES  (10)

/******************************************************************************/
#define AI_NETWORK_N_NODES (132)
